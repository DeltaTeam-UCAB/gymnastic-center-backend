...
import { IMAGE_NOT_EXIST } from '../../../../../src/course/application/errors/image.not.exist'
...
export const name = 'Should not create course with unvalid image'
export const body = async () => {
    ...
    result.handleError((e) => {
        lookFor(e.name).equals(IMAGE_NOT_EXIST)
    })
}
