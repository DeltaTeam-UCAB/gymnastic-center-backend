...
import { Image } from 'src/category/application/models/image'
import { ImageRepository } from 'src/category/application/repositories/image.repository'
import { Image as ImageORM } from '../../models/postgres/image.entity'
import { Repository } from 'typeorm'

@Injectable()
export class ImagePostgresByCategoryRepository implements ImageRepository {
    constructor(
