...
import { UserRedisRepositoryProxy } from '../repositories/redis/user-auth.repository.proxy'
import { CurrentUserQuery } from '../auth/current/current.query'
import { UserPostgresByCommentAuthRepository } from '../repositories/postgres/user-auth.repository'

@Injectable()
export class UserGuard implements CanActivate {
    constructor(
        private userRepo: UserPostgresByCommentAuthRepository,
